...
#pragma mark - ************** 若未定义snprintf，则定义_mxml_snprintf    格式化字符串
...
#pragma mark - ************** 若未定义strdup  则定义_mxml_strdup  复制字符串
/*
...
#pragma mark - ************** 若未定义vsnprintf  则定义_mxml_vsnprintf  格式化字符串到一个固定长度的buffer中
...
#pragma mark - **********_mxml_vstrdupf 格式化并复制字符串
/*
