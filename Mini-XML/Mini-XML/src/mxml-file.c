...
#pragma mark - ********************* xml文件的读取，修改，写入，创建的函数声明
/*
 * Local functions...
 */
...
#pragma mark - ***************************** 对上面声明的函数的实现
#pragma mark - ***************** 加载一个文件描述符中的文件到xml节点树
/*
...
#pragma mark - ***************** 保存一个xml节点树到分配的字符串中
/*
               ...
               mxml_save_cb_t cb)	/* I - Whitespace callback or MXML_NO_CALLBACK */
{
    ...
    return (ptr[0] - buffer);/*有疑问？？？？？*/
}

#pragma mark - ***************** 加载文件描述符中文件到xml节点树中，用SAX回调
/*
...
#pragma mark - ***************** 加载文件到xml节点树中，用SAX回调
/*
...
#pragma mark - ***************** 加载字符串到xml节点树中，用SAX回调
/*
...
#pragma mark - ***************** 添加字符串到buffer中，按需求扩展
/*
...
#pragma mark - ***************** 从文件描述符中读取一个数据到buffer中
/*
...
#pragma mark - ***************** 将buffer中数据写到文件描述符中
/*
