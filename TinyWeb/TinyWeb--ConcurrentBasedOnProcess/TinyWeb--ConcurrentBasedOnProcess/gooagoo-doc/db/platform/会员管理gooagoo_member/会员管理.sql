drop index phyno_index on card_up_info;

drop index member on card_up_info;
...
/* Index: member                                                */
/*==============================================================*/
create unique index member on card_up_info
(
   shop_id,
   phy_no
);
...
/* Index: phyno_index                                           */
/*==============================================================*/
create index phyno_index on card_up_info
(
   phy_no
);
